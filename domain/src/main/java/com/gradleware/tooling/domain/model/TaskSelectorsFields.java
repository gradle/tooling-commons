...
public final class TaskSelectorsFields {
    ...
    public static final ModelField<String, TaskSelectorsFields> NAME =
            new ModelField<String, TaskSelectorsFields>(TypeToken.of(String.class), TypeToken.of(TaskSelectorsFields.class));
    ...
    public static final ModelField<Boolean, TaskSelectorsFields> IS_PUBLIC =
            new ModelField<Boolean, TaskSelectorsFields>(TypeToken.of(Boolean.class), TypeToken.of(TaskSelectorsFields.class), Suppliers.ofInstance(true));
    ...
    public static final ModelField<SortedSet<String>, TaskSelectorsFields> SELECTED_TASK_PATHS =
            new ModelField<SortedSet<String>, TaskSelectorsFields>(TypeTokens.sortedSetToken(String.class), TypeToken.of(TaskSelectorsFields.class));
