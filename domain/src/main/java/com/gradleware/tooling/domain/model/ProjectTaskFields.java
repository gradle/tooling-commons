...
public final class ProjectTaskFields {
    ...
    public static final ModelField<String, ProjectTaskFields> NAME =
            new ModelField<String, ProjectTaskFields>(TypeToken.of(String.class), TypeToken.of(ProjectTaskFields.class));
    ...
    public static final ModelField<Boolean, ProjectTaskFields> IS_PUBLIC =
            new ModelField<Boolean, ProjectTaskFields>(TypeToken.of(Boolean.class), TypeToken.of(ProjectTaskFields.class), Suppliers.ofInstance(true));
