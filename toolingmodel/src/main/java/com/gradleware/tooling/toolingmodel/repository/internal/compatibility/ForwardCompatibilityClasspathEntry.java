...
/**
 * Provides Tooling API access to {@code ClasspathEntry} instances from older clients.
 *
 ...
 * @author Donat Csikos
 */
public interface ForwardCompatibilityClasspathEntry {

    DomainObjectSet<? extends ClasspathAttribute> getClasspathAttributes();

    DomainObjectSet<? extends ForwardCompatibilityAccessRule> getAccessRules();
}
