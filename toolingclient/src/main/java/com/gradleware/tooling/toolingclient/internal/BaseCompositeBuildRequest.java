 ...
 * @author Stefan Oehme
 */
abstract class BaseCompositeBuildRequest<T, SELF extends BaseCompositeBuildRequest<T, SELF>> extends BaseRequest<ModelResults<T>, SELF>implements InspectableCompositeBuildRequest<T> {
